...
REELS=[
 {"id":"reel04","kicker_hook":"Ortopedia Pediátrica","hook":"Pernas em X ou arqueadas: é normal?",
  ...
  "caption":cap("Joelhos arqueados nos primeiros 2 anos e em X dos 3 aos 6 costumam fazer parte do desenvolvimento e melhoram sozinhos. Vale avaliar quando é só de um lado, piora com a idade ou é muito acentuado.","#joelhovalgo #ortopediapediatrica #ortopediainfantil #saudedacrianca #ortopediasaopaulo")},
 {"id":"reel05","kicker_hook":"Ortopedia Pediátrica","hook":"Pé chato na criança preocupa?",
  ...
  "caption":cap("O pé plano flexível é comum na infância e o arco costuma se formar ao longo do crescimento — geralmente não precisa de palmilha. Vale avaliar quando há dor, cansaço fácil, rigidez ou assimetria.","#peplano #pechato #ortopediapediatrica #ortopediainfantil #ortopediasaopaulo")},
 {"id":"reel06","kicker_hook":"Coluna","hook":"Escoliose: como perceber cedo.",
  ...
  "caption":cap("A escoliose costuma ser indolor no começo — por isso observar a postura ajuda. Ombros ou cintura assimétricos e, ao inclinar o tronco à frente, um lado das costas mais alto merecem avaliação. Quanto antes, mais simples o acompanhamento.","#escoliose #colunainfantil #ortopediapediatrica #postura #ortopediasaopaulo")},
 {"id":"reel07","kicker_hook":"Adolescente atleta","hook":"Dor abaixo do joelho que treina muito?",
  ...
  "caption":cap("A doença de Osgood-Schlatter causa dor logo abaixo da patela em adolescentes que treinam, no período do estirão. Costuma melhorar ajustando a carga, com gelo e alongamento. Se a dor persiste ou limita, vale avaliar.","#osgoodschlatter #joelho #ortopediadoesporte #adolescente #ortopediasaopaulo")},
 {"id":"reel08","kicker_hook":"Sinal de alerta","hook":"Dor no quadril ou joelho no pré-adolescente.",
  ...
  "caption":cap("No pré-adolescente, dor no quadril ou no joelho com claudicação, sem trauma claro, merece avaliação sem demora — o joelho às vezes \"avisa\" um problema do quadril. A avaliação precoce faz diferença no resultado.","#quadril #epifisiolise #ortopediapediatrica #sinaldealerta #ortopediasaopaulo")},
 {"id":"reel09","kicker_hook":"Bebê","hook":"Cabecinha sempre virada para o mesmo lado?",
  ...
  "caption":cap("O torcicolo muscular congênito faz o bebê preferir virar a cabeça para um lado, às vezes com um nódulo no pescoço. Identificado cedo, costuma responder bem a alongamentos orientados e acompanhamento.","#torcicolo #bebe #ortopediapediatrica #ortopediainfantil #ortopediasaopaulo")},
 {"id":"reel10","kicker_hook":"Primeiros socorros","hook":"Criança não mexe o braço após puxão?",
  ...
  "cta_title":"Na dúvida, avalie.",
  "caption":cap("A pronação dolorosa (\"cotovelo de babá\") acontece quando o bracinho é puxado, comum em crianças pequenas: ela passa a segurar o braço sem mexer. Não force — a correção pelo ortopedista costuma ser rápida.","#cotovelodebaba #pronacaodolorosa #ortopediapediatrica #ortopediainfantil #ortopediasaopaulo")},
 {"id":"reel11","kicker_hook":"Entenda","hook":"Por que fratura de criança é diferente?",
  ...
  "caption":cap("O osso da criança tem a placa de crescimento (fise), uma região mais frágil e importante. Por isso fraturas infantis têm avaliação e acompanhamento próprios — e costumam consolidar mais rápido que no adulto.","#fratura #placadecrescimento #ortopediapediatrica #ortopediainfantil #ortopediasaopaulo")},
 {"id":"reel12","kicker_hook":"Mito x verdade","hook":"Sapato firme ajuda o bebê a andar?",
  ...
  "caption":cap("Para a maioria dos bebês, andar descalço em casa ajuda a fortalecer o pé e o equilíbrio. O sapato serve de proteção — prefira solado flexível e tamanho confortável, não \"sapato ortopédico\" sem indicação.","#primeirospassos #pedobebe #ortopediapediatrica #mitoouverdade #ortopediasaopaulo")},
 {"id":"reel13","kicker_hook":"Desenvolvimento","hook":"Com que idade a criança anda?",
  ...
  "cta_title":"Na dúvida, avalie.",
  "caption":cap("Andar entre 12 e 15 meses é o mais comum, mas a faixa normal vai além. Vale avaliar quando a criança não anda após 18 meses, perde habilidades já conquistadas ou mostra assimetria de movimento.","#desenvolvimento #marcos #ortopediapediatrica #ortopediainfantil #ortopediasaopaulo")},
 {"id":"reel14","kicker_hook":"Emergência","hook":"Articulação inchada, quente e com febre?",
  ...
  "caption":cap("Articulação subitamente inchada, quente e dolorosa, com febre e recusa a movimentar o membro, pode ser artrite séptica — uma urgência. Procure atendimento imediato: o diagnóstico e o tratamento precoces protegem a articulação.","#artriteseptica #emergencia #ortopediapediatrica #sinaldealerta #ortopediasaopaulo")},
 ...
 {"id":"reel17","kicker_hook":"Alongamento Ósseo","hook":"Dói durante o alongamento ósseo?",
  ...
  "caption":cap("Algum desconforto pode aparecer no alongamento, sobretudo na fase de distração, e costuma ser controlável com o acompanhamento da equipe e fisioterapia. Cada fase tem seu cuidado — o plano é feito para o seu caso.","#alongamentoosseo #reconstrucaoossea #fisioterapia #ortopediasaopaulo #ortopedia")},
 ...
 {"id":"reel19","kicker_hook":"Reconstrução Óssea","hook":"Como se reconstrói osso após infecção?",
  ...
  "caption":cap("Após infecções com perda óssea, a reconstrução é por etapas: controlar a infecção e, depois, recompor o osso — às vezes com transporte ósseo, em que o próprio osso preenche a falha gradualmente. São casos complexos, com plano individual.","#transporteosseo #reconstrucaoossea #osteomielite #ortopedia #ortopediasaopaulo")},
 ...
 {"id":"reel21","kicker_hook":"Ortopedia Pediátrica","hook":"Andar com os pés para fora: é problema?",
  ...
  "cta_title":"Na dúvida, avalie.",
  "caption":cap("Andar com os pés para fora (ou para dentro) costuma fazer parte do desenvolvimento e melhora com o crescimento, refletindo a rotação natural dos ossos. Avalie quando é muito assimétrico, causa quedas ou piora.","#marcha #rotacao #ortopediapediatrica #ortopediainfantil #ortopediasaopaulo")},
 {"id":"reel22","kicker_hook":"Saúde óssea","hook":"Vitamina D e ossos fortes na infância.",
  ...
  "caption":cap("A vitamina D ajuda o corpo a usar o cálcio e sustenta o crescimento ósseo. Sol e alimentação contribuem, mas a necessidade de suplemento é individual — vale avaliar antes de iniciar por conta própria.","#vitaminad #saudeossea #ortopediapediatrica #ortopediainfantil #ortopediasaopaulo")},
 {"id":"reel23","kicker_hook":"Mito x verdade","hook":"Mochila pesada causa escoliose?",
  ...
  "caption":cap("Mochila pesada não causa escoliose, mas pode gerar dor e estimular má postura. Prefira mochila com as duas alças, bem ajustada às costas, levando só o necessário — idealmente até cerca de 10 a 15% do peso da criança.","#mochila #postura #ortopediapediatrica #mitoouverdade #ortopediasaopaulo")},
 ...
 {"id":"reel27","kicker_hook":"Ortopedia Pediátrica","hook":"Criança que cansa para andar e sente dor.",
  ...
  "cta_title":"Na dúvida, avalie.",
  "caption":cap("Criança que cansa muito mais que os colegas, sente dor que limita o brincar ou muda o jeito de andar merece avaliação. Muitas vezes é leve e tranquilizamos; quando há algo a tratar, quanto antes melhor.","#dor #marcha #ortopediapediatrica #saudedacrianca #ortopediasaopaulo")},
 {"id":"reel28","kicker_hook":"Deformidades complexas","hook":"Deformidade nas pernas tem correção?",
  ...
  "cta_title":"Quer entender o seu caso?",
  "caption":cap("Deformidades angulares das pernas podem ser corrigidas com planejamento: medir o eixo com precisão, definir o ponto de correção e, muitas vezes, corrigir de forma gradual e acompanhada. O foco é segurança e função.","#deformidades #reconstrucaoossea #alongamentoosseo #ortopedia #ortopediasaopaulo")},
 {"id":"reel29","kicker_hook":"Ossos frágeis","hook":"Criança que fratura com facilidade.",
  ...
  "cta_title":"Convive com isso? Vamos avaliar.",
  "caption":cap("Fraturas repetidas com pequenos traumas, às vezes com histórico familiar, merecem investigação — pode haver uma condição óssea, como a osteogênese imperfeita. O cuidado é especializado e acompanha o crescimento.","#osteogeneseimperfeita #ossosfrageis #ortopediapediatrica #ortopediainfantil #ortopediasaopaulo")},
