...
C22=NL.join(["Como o corpo cria osso novo durante o alongamento ósseo.","Parece incrível, mas o próprio corpo regenera osso. Depois de um corte ósseo planejado, o tratamento segue em fases: um tempo de espera (latência), o afastamento gradual milímetro a milímetro (distração) e, por fim, o endurecimento do osso novo (consolidação).","É por isso que o alongamento é um tratamento de etapas, com acompanhamento próximo — cada fase tem o seu tempo e o seu cuidado.","Quer entender como seria no seu caso? WhatsApp no link da bio."])
C23=NL.join(["Deformidades de causa neurológica: a ortopedia pediátrica também ajuda.","Condições como mielomeningocele e paralisia cerebral podem afetar o equilíbrio muscular e levar a deformidades nos membros, quadris e pés ao longo do crescimento.","O cuidado é em equipe e por etapas: acompanhar o crescimento, prevenir deformidades quando possível e corrigir o que atrapalha o sentar, o ficar de pé ou o andar. O objetivo é função e conforto no dia a dia.","Convive com uma dessas condições? WhatsApp no link da bio."])
C24=NL.join(["Dor de crescimento ou dor que precisa de avaliação na ortopedia pediátrica?","A chamada dor de crescimento é comum, costuma vir no fim do dia ou à noite, nas duas pernas, e melhora pela manhã e com massagem. Não causa mancar nem incha.","Vale procurar avaliação quando a dor é só de um lado, vem com inchaço, vermelhidão ou febre, faz a criança mancar, atrapalha o brincar ou aparece sempre no mesmo ponto.","Na dúvida, observar de perto é o melhor caminho. WhatsApp no link da bio."])
