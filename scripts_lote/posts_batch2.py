...
POSTS=[
 ...
 ("post45",[
  ...
  cap("Em casos complexos de deformidade e reconstrução — pseudoartrose, discrepância de membro, sequelas —, um segundo olhar cuidadoso às vezes revela opções. Não prometo milagre — proponho avaliação honesta, plano realista e acompanhamento próximo.","#segundaopiniao #casoscomplexos #reconstrucaoossea #deformidades #ortopediasaopaulo")),
 ("post46",[
  ...
  cap("Na primeira consulta — seja de reconstrução, alongamento ósseo ou ortopedia pediátrica —, escuto a história, examino com calma e explico em linguagem clara. A ideia é você sair entendendo o problema e os próximos passos, com espaço para todas as perguntas.","#primeiraconsulta #ortopedia #ortopediapediatrica #reconstrucaoossea #ortopediasaopaulo")),
 ("post47",[
  ...
  cap("Criança que cansa muito mais que os colegas, sente dor que limita o brincar ou muda o jeito de andar merece avaliação na ortopedia pediátrica. Muitas vezes é leve; quando há algo a tratar, quanto antes melhor.","#dor #marcha #ortopediapediatrica #saudedacrianca #ortopediasaopaulo")),
 ("post48",[
  ...
  cap("Deformidades angulares das pernas podem ser corrigidas com planejamento: medir o eixo, definir o ponto da osteotomia e, muitas vezes, corrigir de forma gradual e acompanhada. O foco é segurança e função.","#deformidades #reconstrucaoossea #alongamentoosseo #ortopedia #ortopediasaopaulo")),
 ("post49",[
  ...
  cap("Fraturas repetidas com pequenos traumas, às vezes com histórico familiar, merecem investigação — pode haver uma condição óssea, como a osteogênese imperfeita. O cuidado é especializado, na ortopedia pediátrica, e acompanha o crescimento.","#osteogeneseimperfeita #ossosfrageis #ortopediapediatrica #ortopediainfantil #ortopediasaopaulo")),
 ("post50",[
 ...
 ("post51",[
  ...
  cap("No pé cavo, o arco é mais alto que o habitual e o peso se concentra em poucos pontos. Quando é acentuado ou progride, vale investigar a causa. O tratamento depende da avaliação de cada caso na ortopedia pediátrica.","#pecavo #ortopediapediatrica #ortopediainfantil #pe #ortopediasaopaulo")),
 ("post52",[
  ...
  cap("A doença de Sever causa dor no calcanhar em crianças e adolescentes ativos, na área de crescimento do osso. Costuma melhorar com ajuste de carga, gelo e alongamento. Se persiste, vale avaliar na ortopedia pediátrica.","#doencadesever #calcanhar #ortopediadoesporte #ortopediapediatrica #ortopediasaopaulo")),
 ("post53",[
   ...
   {"variant":"dark","kicker":"Converse comigo","title":"Na dúvida, avalie","body":"Fale comigo pelo WhatsApp — link na bio.","foot":SIG,"tsize":80}],
  cap("Articulações que estalam sem dor, inchaço ou travamento costumam ser benignas. O estalo acompanhado de dor, inchaço, travamento ou falseio é que merece avaliação — na criança, na ortopedia pediátrica. O sintoma guia, não o barulho.","#estalos #articulacoes #ortopedia #ortopediapediatrica #ortopediasaopaulo")),
 ("post54",[
  ...
  cap("A hipermobilidade (frouxidão ligamentar) é comum e, em muitos, é só uma característica. Algumas crianças têm dores após esforço; atividade física e fortalecimento muscular costumam ajudar, com orientação da ortopedia pediátrica.","#hipermobilidade #frouxidaoligamentar #ortopediapediatrica #ortopediainfantil #ortopediasaopaulo")),
 ("post55",[
   ...
   {"variant":"dark","kicker":"Converse comigo","title":"Dor que não passa?","body":"Fale comigo pelo WhatsApp — link na bio.","foot":SIG,"tsize":76}],
  cap("Dor nas costas persistente na criança merece atenção. Sinais como dor noturna, febre, perda de peso ou que limita as atividades pedem avaliação na ortopedia pediátrica. Na maioria é simples, mas vale investigar quando há alerta.","#dornascostas #colunainfantil #ortopediapediatrica #sinaldealerta #ortopediasaopaulo")),
 ("post56",[
  ...
  cap("Para a criança atleta, variar atividades, respeitar o descanso, aquecer e fortalecer reduzem lesões por excesso de uso. Dor que persiste ou limita o esporte deve ser avaliada na ortopedia pediátrica — não é normal.","#esporteinfantil #prevencao #ortopediadoesporte #ortopediapediatrica #ortopediasaopaulo")),
 ("post57",[
  ...
  cap("Na torção de tornozelo, proteger, aplicar gelo e elevar ajuda no início. Não apoiar o pé, inchaço importante ou dor que não melhora merecem avaliação na ortopedia pediátrica. Fortalecer e treinar equilíbrio reduz o risco de novas torções.","#entorse #tornozelo #ortopediadoesporte #adolescente #ortopediasaopaulo")),
 ("post58",[
  ...
  cap("Para aproveitar a consulta — de ortopedia pediátrica, reconstrução ou alongamento ósseo —, leve a história do problema (quando começou, o que melhora/piora, tratamentos já feitos), os exames que já tem (mesmo antigos) e uma lista das suas dúvidas.","#consulta #ortopedia #ortopediapediatrica #reconstrucaoossea #ortopediasaopaulo")),
 ("post59",[
  ...
  cap("A sensação de joelho que \"falseia\" no adolescente pode ser instabilidade da patela, que escapa para o lado. Fortalecimento costuma ser a base; alguns casos pedem avaliação mais detalhada na ortopedia pediátrica.","#instabilidadepatelar #joelho #ortopediapediatrica #adolescente #ortopediasaopaulo")),
 ("post60",[
  ...
  cap("Arqueamento das pernas que piora, é assimétrico ou vem com baixa estatura pode não ser só do crescimento — às vezes há causa, como o raquitismo. Avaliar e tratar a origem — às vezes corrigindo a deformidade com osteotomia — ajuda a restabelecer o alinhamento.","#raquitismo #deformidades #ortopediapediatrica #saudeossea #ortopediasaopaulo")),
 ("post61",[
  ...
  cap("Para deformidades e problemas ósseos de difícil solução — pseudoartrose, discrepância de membro, sequelas —, em crianças e adultos, a proposta é um tratamento guiado e seriado: avaliação cuidadosa, plano realista e correção em etapas, com foco em função e qualidade de vida.","#reconstrucaoossea #alongamentoosseo #deformidades #casoscomplexos #ortopediasaopaulo")),
]
