...
OSSO_NOVO = [
 ...
 {"id":"on_medir_antes","ep":12,"serie":"Osso Novo","temporada":"os-caminhos-do-conserto","motif_family":"bone",
  "scenes":[
   ...
   {"k":"Passa adiante","sc":["Salva: medir","é metade do tratamento."],"e":None,"sub":"Manda pra quem vai investigar uma diferença nas pernas.","cta":True,
    "vo":"Salva isso: medir é metade do tratamento. E com o quê se corrige de verdade? Fixador por fora ou haste por dentro. É o próximo."},
  ],
 ...
 {"id":"on_fixador_vs_haste","ep":13,"serie":"Osso Novo","temporada":"os-caminhos-do-conserto","motif_family":"bone",
  "scenes":[
   {"k":"Duas ferramentas","sc":["Por fora ou","por dentro?"],"e":None,"sub":"Os dois corrigem e alongam osso — de jeitos diferentes.",
    "vo":"Quando o assunto é alongar ou corrigir osso, existem dois grandes caminhos: um aparelho por fora ou uma haste por dentro. Os dois funcionam, de jeitos diferentes."},
   {"k":"Fixador externo","sc":["Uma estrutura","por fora da perna."],"e":None,"sub":"Pinos atravessam até o osso; ajusta de fora, mas pede cuidado diário.",
    "vo":"O fixador externo é aquela estrutura por fora, com pinos que vão até o osso. Permite ajustar de fora com precisão, mas pede cuidado diário e fica visível por um tempo."},
   {"k":"Haste interna","sc":["Um pino dentro","do próprio osso."],"e":None,"sub":"Algumas alongam por controle externo; mais discreta, com indicações próprias.",
    "vo":"Já a haste interna fica dentro do osso, escondida. Algumas modernas até alongam por controle remoto. É mais discreta, mas tem indicações próprias e limites."},
   {"k":"Qual escolher","sc":["Depende do caso,","não da moda."],"e":None,"sub":"Tamanho da correção, osso, idade e infecção pesam na escolha.",
    "vo":"E qual é melhor? Depende. O tamanho da correção, o estado do osso, a idade e o histórico de infecção é que apontam a melhor ferramenta. Não existe resposta única."},
   {"k":"Passa adiante","sc":["Salva: fixador","x haste."],"e":None,"sub":"Manda pra quem está pesquisando antes de operar.","cta":True,
    "vo":"Salva essa comparação. E a pergunta número um de quem vai operar: quanto tempo eu fico com isso? É o próximo."},
  ],
  "caption":cap_rec("Fixador externo x haste interna. Os dois corrigem e alongam osso, de jeitos diferentes. O fixador externo é a estrutura por fora, com pinos até o osso: permite ajuste fino de fora, mas pede cuidado diário e fica visível por um tempo. A haste interna fica dentro do osso, discreta — algumas modernas alongam por controle externo, com indicações próprias. Qual usar depende do caso (tamanho da correção, estado do osso, idade, infecção), não da moda. Aqui, alongar e corrigir osso é sempre sobre função — nunca estética ou altura.","#fixadorexterno #hasteintramedular")},
