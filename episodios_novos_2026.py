...
PE_NO_CHAO_NOVOS = [
 ...
 {"id":"pnc_pe_pra_dentro","ep":10,"serie":"Pé no Chão","temporada":"pernas-e-pes",
  "scenes":[
   {"k":"Pé pra dentro","sc":["Anda com o pé","virado pra dentro?"],"e":None,"sub":"O 'andar de pombinho' na maioria das vezes alinha sozinho.",
    "vo":"Criança que anda com o pé virado pra dentro, de pombinho, na maioria das vezes alinha sozinha, sem precisar de nada."},
   {"k":"De onde vem","sc":["Do pé, da canela","ou da coxa."],"e":None,"sub":"Leves torções do crescimento; a rotação se ajusta com o tempo.",
    "vo":"Pode vir de uma leve torção do pé, da canela ou da coxa — variações comuns; o crescimento costuma ajustar a rotação."},
   {"k":"Quando avaliar","sc":["Só um lado, dói,","ou piora."],"e":None,"sub":"Assimetria, dor, quedas demais ou piora pedem avaliação.","motif":None,
    "vo":"O alerta: só de um lado, dor, quedas demais, ou piora em vez de melhora. Aí vale o ortopedista olhar."},
   {"k":"Passa adiante","sc":["Manda pra quem vive","com essa dúvida."],"e":None,"sub":"Manda pra mãe preocupada com o 'andar de pombinho'. E salva.","cta":True,
    "vo":"Manda pra aquela mãe preocupada com o andar de pombinho, e salva pra lembrar."},
  ],
 ...
 {"id":"pnc_estalo_joelho","ep":11,"serie":"Pé no Chão","temporada":"pernas-e-pes",
  "scenes":[
   {"k":"Aquele 'crec'","sc":["O joelho da criança","estala?"],"e":None,"sub":"Som sem dor quase sempre é inofensivo.",
    "vo":"Estalo no joelho da criança, sem dor, é quase sempre inofensivo — mesmo assustando os pais."},
   {"k":"Por que estala","sc":["Tendão, articulação,","bolha de ar."],"e":None,"sub":"Tendões deslizando, gás dentro da articulação — fenômenos normais.",
    "vo":"O barulho costuma ser tendão deslizando sobre o osso ou bolhas de gás na articulação. Fenômenos normais do corpo."},
   {"k":"Quando olhar de perto","sc":["Estala e dói,","trava ou incha."],"e":None,"sub":"Sem dor e sem inchaço, é só som; com dor ou travamento, avalie.","motif":None,
    "vo":"Se ela corre, pula e brinca sem reclamar e sem inchaço, é só som. Atenção quando o estalo vem com dor, inchaço ou joelho travando."},
   {"k":"Passa adiante","sc":["Manda pra quem se","assusta com o 'crec'."],"e":None,"sub":"Manda pra quem se assusta com o joelho que estala. E salva.","cta":True,
    "vo":"Manda pra quem se assusta com o joelho que estala, e salva pra consultar depois."},
  ],
 ...
 {"id":"pnc_tenis_caro","ep":12,"serie":"Pé no Chão","temporada":"pernas-e-pes",
  "scenes":[
   {"k":"Mito caro","sc":["Tênis caro NÃO","corrige o pé."],"e":"NÃO","sub":"O pé da criança não se molda pelo calçado.","motif":"no",
    "vo":"Tênis caro não corrige nem molda o pé da criança. Essa ideia vende muito, mas o pé não funciona assim."},
   {"k":"Como o pé se forma","sc":["Andando, correndo,","sentindo o chão."],"e":None,"sub":"O pé se desenvolve com movimento; o sapato só protege.",
    "vo":"O pé se desenvolve com movimento: andando, correndo, sentindo o chão. O sapato só protege — flexível, leve e no tamanho certo basta."},
   {"k":"A dica que vale","sc":["Pé no chão,","quando der."],"e":None,"sub":"Tempo descalço em casa, em piso seguro, estimula o pé de verdade.",
    "vo":"A dica que ajuda não custa nada: tempo descalço em casa, num chão seguro. Isso estimula o pé de verdade."},
   {"k":"Passa adiante","sc":["Manda antes de","gastarem no tênis."],"e":None,"sub":"Manda pra quem vai gastar caro achando que corrige. E salva.","cta":True,
    "vo":"Manda pra quem ia gastar caro achando que corrige, e salva antes de comprar."},
  ],
 ...
 {"id":"pnc_perna_curta_crianca","ep":13,"serie":"Pé no Chão","temporada":"pernas-e-pes",
  "scenes":[
   {"k":"Pequena é comum","sc":["Uma perna mais","curta que a outra."],"e":None,"sub":"Diferenças bem pequenas são comuns e não dão sintoma.",
    "vo":"Uma perna mais curta na criança: diferenças bem pequenas quase todo mundo tem, e não causam problema."},
   {"k":"O diferencial da criança","sc":["Ela ainda","está crescendo."],"e":"crescendo","sub":"Como cresce, dá pra prever a diferença final e planejar com tempo.",
    "vo":"O trunfo da criança é o crescimento: como ela ainda vai crescer, dá pra prever a diferença final e planejar com calma, se precisar."},
   {"k":"Quando observar","sc":["Manca, ou a","diferença é visível."],"e":None,"sub":"Mancar, desnível no quadril ou diferença nítida pede avaliação.",
    "vo":"Vale avaliar quando ela manca, o quadril fica desnivelado ou a diferença é nítida. Medir cedo abre as melhores opções."},
 ...
 {"id":"pnc_nao_dor_crescimento","ep":14,"serie":"Pé no Chão","temporada":"sinais-de-alerta",
  "scenes":[
   {"k":"O outro lado","sc":["Nem toda dor é","de crescimento."],"e":None,"sub":"Alguns sinais mostram quando pode ser outra coisa.",
    "vo":"Nem toda dor na perna é dor de crescimento. Alguns sinais mostram quando pode ser outra coisa."},
   {"k":"Sinal 1","sc":["Sempre no","mesmo ponto."],"e":None,"sub":"Dor de crescimento é difusa; dor fixa num lugar pede atenção.",
    "vo":"Dor de crescimento é espalhada, vaga. Dor sempre no mesmo ponto foge do padrão."},
   {"k":"Sinais 2 e 3","sc":["Inchaço, calor","ou febre junto."],"e":None,"sub":"Articulação inchada, quente, ou febre não combinam com o quadro.",
    "vo":"Inchaço e calor numa articulação, ou febre junto da dor, também não fazem parte do quadro clássico."},
   {"k":"Sinal 4","sc":["Atrapalha o dia,","não só a noite."],"e":None,"sub":"Dor que faz mancar ou limita o brincar: avalie.",
    "vo":"E quando a dor invade o dia, fazendo mancar ou limitar o brincar, não espere: avalie."},
   {"k":"Passa adiante","sc":["Manda os sinais que","fogem do padrão."],"e":None,"sub":"Manda pra quem fica na dúvida toda noite. E salva.","cta":True,
    "vo":"Manda pra quem fica na dúvida toda noite, e salva esses sinais."},
  ],
 ...
 {"id":"pnc_mancando","ep":15,"serie":"Pé no Chão","temporada":"sinais-de-alerta",
  "scenes":[
   {"k":"Regra de ouro","sc":["Criança mancando","sempre se avalia."],"e":"sempre","sub":"Manqueira não é manha — é um sinal que pede explicação.",
    "vo":"Criança mancando sempre merece avaliação. Manqueira não é manha: é o corpo avisando alguma coisa."},
   {"k":"Por que levar a sério","sc":["O corpo está","protegendo algo."],"e":None,"sub":"Fugir de dor ou compensar fraqueza; as causas mudam com a idade.",
    "vo":"Ela manca pra fugir de uma dor ou compensar uma fraqueza. As causas variam com a idade, de sapato apertado a quadril que pede mais pressa."},
   {"k":"O que observar","sc":["Há quanto tempo,","e com o quê."],"e":None,"sub":"Tempo de manqueira, dor, febre e o lado ajudam muito o médico.",
    "vo":"Antes da consulta, repare: há quanto tempo manca, se tem dor, se veio febre, se é sempre do mesmo lado."},
   {"k":"Passa adiante","sc":["Manda: mancar","sempre se investiga."],"e":None,"sub":"Manda pra quem acha que vai passar sozinho. E salva.","cta":True,
    "vo":"Manda pra quem acha que manqueira passa sozinha, e salva essa regra."},
  ],
 ...
 {"id":"pnc_mancar_febre","ep":16,"serie":"Pé no Chão","temporada":"sinais-de-alerta",
  "scenes":[
   {"k":"Combinação que apressa","sc":["Mancar + febre","pede pressa."],"e":None,"sub":"Juntos, são um sinal de urgência — eu explico sem alarde.",
    "vo":"Criança mancando com febre é combinação que pede pressa. Cada um sozinho pode ser bobo; juntos, não esperam."},
   {"k":"Por que correr","sc":["Pode ser infecção","na articulação."],"e":None,"sub":"Articulação infectada precisa de avaliação urgente.",
    "vo":"Uma das causas é infecção dentro da articulação, das poucas urgências da ortopedia infantil. Quanto antes avaliar, melhor."},
   {"k":"O que fazer","sc":["Procure atendimento.","Não espere passar."],"e":None,"sub":"Não apoiar a perna e chorar ao mexer reforçam a pressa: avaliar no mesmo dia.",
    "vo":"Se ela não apoia a perna e chora ao mexer, a pressa aumenta. Com febre e manqueira juntas, procure atendimento no mesmo dia."},
   {"k":"Passa adiante","sc":["Manda: febre +","manca = avaliar já."],"e":None,"sub":"Manda pra todo pai e mãe — esse pode importar muito. E salva.","cta":True,
    "vo":"Manda pra todo pai e mãe, porque esse pode fazer diferença de verdade. E salva."},
  ],
 ...
 {"id":"pnc_escoliose","ep":17,"serie":"Pé no Chão","temporada":"sinais-de-alerta",
  "scenes":[
   {"k":"Olhe as costas","sc":["Nem todo sinal","está nas pernas."],"e":None,"sub":"A coluna também dá pistas — e dá pra checar em casa.",
    "vo":"Escoliose, o desvio da coluna, dá pra começar a checar em casa, num teste simples."},
   {"k":"O que é","sc":["A coluna entorta","para o lado."],"e":None,"sub":"Um desvio em curva, que costuma aparecer no estirão.",
    "vo":"É quando a coluna, vista por trás, faz uma curva pro lado. Costuma aparecer no estirão da pré-adolescência."},
   {"k":"O teste de casa","sc":["Peça pra inclinar","o corpo à frente."],"e":None,"sub":"Ao se curvar pra frente, um lado das costas mais alto chama atenção.",
    "vo":"Peça pra ela se inclinar pra frente, como quem toca os pés, e olhe as costas de cima. Um lado mais alto vale mostrar ao médico."},
   {"k":"Passa adiante","sc":["Manda o teste","da inclinação."],"e":None,"sub":"Manda pra pais de pré-adolescentes. E salva.","cta":True,
    "vo":"Perceber cedo costuma deixar o acompanhamento mais simples. Manda o teste pra pais de pré-adolescente, e salva."},
  ],
 ...
 {"id":"pnc_cai_muito","ep":18,"serie":"Pé no Chão","temporada":"mito-ou-verdade",
  "scenes":[
   {"k":"Cai toda hora","sc":["Criança que cai","muito: é normal?"],"e":None,"sub":"Nos primeiros anos, cair é como o corpo calibra o equilíbrio.",
    "vo":"Criança que cai muito: uma boa dose de tombo faz parte do aprendizado. Cada queda calibra o equilíbrio."},
   {"k":"Quando reparar","sc":["Piora, ou só","tropeça de um lado."],"e":None,"sub":"Cair cada vez mais, tropeçar sempre do mesmo lado ou regredir pede atenção.",
    "vo":"O que muda o jogo é a tendência: cair cada vez mais, tropeçar sempre do mesmo lado, ou perder uma habilidade que já tinha. Aí vale avaliar."},
   {"k":"O que ajuda em casa","sc":["Chão livre e","pé no chão."],"e":None,"sub":"Espaço seguro pra praticar e tempo descalço ajudam o equilíbrio.",
    "vo":"Em casa, ajuda um espaço livre e seguro pra praticar, e tempo descalço, que melhora a noção de equilíbrio."},
   {"k":"Passa adiante","sc":["Manda: cair faz","parte (até certo ponto)."],"e":None,"sub":"Manda pra quem se preocupa com cada tombo. E salva.","cta":True,
    "vo":"Manda pra quem sofre a cada tombo, e salva."},
  ],
 ...
 {"id":"pnc_sentar_w","ep":19,"serie":"Pé no Chão","temporada":"mito-ou-verdade",
  "scenes":[
   {"k":"O medo viral","sc":["Sentar em 'W'","faz mal?"],"e":None,"sub":"Viralizou como vilão — mas a real é mais tranquila.",
    "vo":"Sentar em W virou vilão na internet, mas a real é bem mais tranquila que os vídeos de susto."},
   {"k":"O que se entende hoje","sc":["Na maioria, não","causa deformidade."],"e":None,"sub":"Base estável pra brincar; em criança que cresce bem, não vira deformidade.",
    "vo":"É uma base larga e estável pra brincar. E numa criança que se desenvolve bem, sentar assim de vez em quando não vira deformidade."},
   {"k":"O bom senso","sc":["Variar é melhor","que proibir."],"e":None,"sub":"Se ela só senta em W, ou já tem outro sinal, vale comentar com o médico.",
    "vo":"O bom senso é estimular a variação, não proibir. Se ela só senta em W, ou tem outros sinais, comente com o ortopedista."},
   {"k":"Passa adiante","sc":["Manda: W não é","o monstro do vídeo."],"e":None,"sub":"Manda pra quem vive corrigindo o filho no chão. E salva.","cta":True,
    "vo":"Manda pra quem vive corrigindo o filho no chão, e salva."},
  ],
 ...
 {"id":"pnc_mochila","ep":20,"serie":"Pé no Chão","temporada":"mito-ou-verdade",
  "scenes":[
   {"k":"O que ela não faz","sc":["Não 'entorta'","a coluna pra sempre."],"e":"não","sub":"Não há prova de que mochila cause escoliose ou deformidade permanente.","motif":"no",
    "vo":"Mochila pesada não entorta a coluna pra sempre: não há prova de que cause escoliose ou deformidade permanente."},
   {"k":"O que ela faz","sc":["Causa dor e má","postura no dia."],"e":None,"sub":"Peso excessivo gera dor nas costas e ombros e postura ruim na hora.",
    "vo":"O peso exagerado causa, sim, dor nas costas e ombros e postura ruim enquanto carrega. Desconforto real do dia a dia."},
   {"k":"A regra prática","sc":["Até uns 10 a 15%","do peso da criança."],"e":None,"sub":"Mochila leve, duas alças, ajustada às costas, e só o essencial dentro.",
    "vo":"A regra prática: mochila cheia até uns dez a quinze por cento do peso da criança, nas duas alças, só com o necessário."},
   {"k":"Passa adiante","sc":["Manda a regra","da mochila."],"e":None,"sub":"Manda pro grupo da escola. E salva.","cta":True,
    "vo":"Manda pro grupo da escola, e salva a regra da mochila."},
  ],
