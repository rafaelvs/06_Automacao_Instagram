...
POS_OP = [
 {"id":"gesso_pos_op","ep":1,"temporada":"pos_operatorio","serie":"Recuperação","motif_family":"bone",
  "scenes":[
   ...
   {"k":"Primeiros dias","sc":["Mantenha o membro","elevado."],"e":"elevado",
    "sub":"Acima do coração, nas primeiras 48 a 72 horas.",
    "vo":"Nos primeiros dois a três dias, deixe o braço ou a perna apoiada em travesseiros, acima da altura do coração. É o que mais desincha. Gelo por cima do gesso também ajuda."},
