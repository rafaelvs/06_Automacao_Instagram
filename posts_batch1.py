...
POSTS=[
 ("post25",[
  ...
  cap("Joelhos arqueados nos primeiros anos e em X dos 3 aos 6 costumam fazer parte do desenvolvimento e melhoram sozinhos. Vale avaliar quando é muito acentuado, assimétrico, piora com a idade ou vem com dor.","#joelhovalgo #joelhovaro #ortopediapediatrica #ortopediainfantil #ortopediasaopaulo")),
 ("post26",[
  ...
  cap("O pé plano flexível é comum na infância e o arco costuma se formar com o crescimento — geralmente sem necessidade de palmilha. Avalie quando há dor, cansaço, rigidez ou assimetria.","#peplano #pechato #ortopediapediatrica #ortopediainfantil #ortopediasaopaulo")),
 ("post27",[
  ...
  cap("A escoliose costuma ser indolor no início. Observe ombros e cintura assimétricos e, ao inclinar o tronco à frente, um lado das costas mais alto. Quanto antes a avaliação, mais simples o acompanhamento.","#escoliose #colunainfantil #ortopediapediatrica #postura #ortopediasaopaulo")),
 ("post28",[
  ...
  cap("A doença de Osgood-Schlatter causa dor abaixo da patela em adolescentes que treinam, no estirão. Costuma melhorar ajustando a carga, com gelo e alongamento. Se persiste ou limita, vale avaliar.","#osgoodschlatter #joelho #ortopediadoesporte #adolescente #ortopediasaopaulo")),
 ("post29",[
  ...
  cap("No pré-adolescente, dor no quadril, coxa ou joelho com claudicação e sem trauma claro merece avaliação sem demora — o joelho às vezes \"avisa\" um problema do quadril. A avaliação precoce faz diferença.","#quadril #epifisiolise #ortopediapediatrica #sinaldealerta #ortopediasaopaulo")),
 ("post30",[
  ...
  cap("O torcicolo muscular congênito faz o bebê preferir um lado, às vezes com um nódulo no pescoço. Identificado cedo, costuma responder bem a alongamentos orientados, prevenindo assimetrias.","#torcicolo #bebe #ortopediapediatrica #ortopediainfantil #ortopediasaopaulo")),
 ("post31",[
  ...
  cap("A pronação dolorosa (\"cotovelo de babá\") ocorre após puxar o bracinho: a criança passa a segurar o braço sem mexer. Não force — a correção costuma ser rápida. Levantar pelas axilas ajuda a prevenir.","#cotovelodebaba #pronacaodolorosa #ortopediapediatrica #ortopediainfantil #ortopediasaopaulo")),
 ("post32",[
  ...
  cap("O osso da criança cresce pela placa de crescimento (fise), uma região mais frágil e importante. Por isso fraturas infantis têm avaliação própria — e costumam consolidar mais rápido que no adulto.","#fratura #placadecrescimento #ortopediapediatrica #ortopediainfantil #ortopediasaopaulo")),
 ("post33",[
  ...
  cap("Para a maioria dos bebês, andar descalço em casa fortalece o pé e o equilíbrio. O sapato é proteção — prefira solado flexível e tamanho confortável, sem necessidade de \"sapato ortopédico\" por rotina.","#primeirospassos #pedobebe #ortopediapediatrica #mitoouverdade #ortopediasaopaulo")),
 ("post34",[
   ...
   {"variant":"dark","kicker":"Converse comigo","title":"Na dúvida, avalie","body":"Fale comigo pelo WhatsApp — link na bio.","foot":SIG,"tsize":80}],
  cap("Andar entre 12 e 15 meses é o mais comum, mas a faixa normal vai além. Avalie quando a criança não anda após 18 meses, perde habilidades já conquistadas ou mostra movimento assimétrico.","#desenvolvimento #marcos #ortopediapediatrica #ortopediainfantil #ortopediasaopaulo")),
 ("post35",[
  ...
  cap("Articulação subitamente inchada, quente e dolorosa, com febre e recusa a movimentar o membro, pode ser artrite séptica — uma urgência. Procure atendimento imediato: tratar cedo protege a articulação.","#artriteseptica #emergencia #ortopediapediatrica #sinaldealerta #ortopediasaopaulo")),
 ("post36",[
  ...
  cap("Diferenças de comprimento entre as pernas são comuns. Pequenas costumam ser bem toleradas; maiores têm opções que vão de palmilha a alongamento, conforme a diferença, a causa, a idade e a expectativa.","#discrepancia #alongamentoosseo #reconstrucaoossea #ortopediapediatrica #ortopediasaopaulo")),
 ("post37",[
  ...
  cap("Na maioria dos casos dá para higienizar a região do fixador seguindo a orientação individual: manter limpo, secar bem os pinos e observar vermelhidão ou secreção. Suas orientações valem mais que regras gerais.","#fixadorexterno #cuidados #reconstrucaoossea #alongamentoosseo #ortopediasaopaulo")),
 ("post38",[
  ...
  cap("Algum desconforto pode aparecer no alongamento, sobretudo na fase de distração, e costuma ser controlável com acompanhamento e fisioterapia. Cada fase tem seu cuidado — o plano é feito para o seu caso.","#alongamentoosseo #reconstrucaoossea #fisioterapia #ortopediasaopaulo #ortopedia")),
 ("post39",[
 ...
 ("post40",[
  ...
  cap("Após infecções com perda óssea, a reconstrução é por etapas: controlar a infecção e depois recompor o osso — às vezes com transporte ósseo, em que o próprio osso preenche a falha gradualmente.","#transporteosseo #reconstrucaoossea #osteomielite #ortopedia #ortopediasaopaulo")),
 ("post41",[
 ...
 ("post42",[
   ...
   {"variant":"dark","kicker":"Converse comigo","title":"Na dúvida, avalie","body":"Fale comigo pelo WhatsApp — link na bio.","foot":SIG,"tsize":80}],
  cap("Andar com os pés para fora (ou para dentro) costuma fazer parte do desenvolvimento e melhora com o crescimento, refletindo a rotação dos ossos. Avalie quando é muito assimétrico, causa quedas ou piora.","#marcha #rotacao #ortopediapediatrica #ortopediainfantil #ortopediasaopaulo")),
 ("post43",[
  ...
  cap("A vitamina D ajuda o corpo a usar o cálcio e sustenta o crescimento ósseo. Sol e alimentação contribuem, mas a necessidade de suplemento é individual — vale avaliar antes de iniciar por conta própria.","#vitaminad #saudeossea #ortopediapediatrica #ortopediainfantil #ortopediasaopaulo")),
]
